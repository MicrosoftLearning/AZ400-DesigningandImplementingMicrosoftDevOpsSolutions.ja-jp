...
1. **[保存および実行]** をクリックし、パイプラインが正常に実行されるまで待ちます。
    ...
    > **注**:**[保存して実行]** を 2 回クリックする必要があります。 [ジョブ] ウィンドウに [アクセス許可が必要です] メッセージが表示された場合は、[ジョブ] ウィンドウで **[デプロイ]** を選択し、**[表示]** を選択し、**[アクセス許可]** を 2 回選択してパイプラインの実行を完了します。
...
1. **[メンバー]** セクションで、**[ID の管理]** をオンにして、**[+ メンバーの選択]** をクリックします。 **[管理 ID]** フィールドで、**[App Service (1)]** を選択し、アプリ サービスを選択して、**[選択]** をクリックします。
1. **[確認して割り当てる]** を 2 回クリックしてロールの割り当てを完了します。
