...
### <a name="exercise-2-query-releaseinformation-via-restapi"></a>演習 2:REST API を介してリリース情報をクエリする
...
#### <a name="task-2-query-releaseinformation-via-restapi-by-using-postman"></a>タスク 2:Postman を使用して REST API を介してリリース情報をクエリする
