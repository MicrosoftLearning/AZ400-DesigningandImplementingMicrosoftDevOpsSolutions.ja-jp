...
1.  「**関連作業**」セクションの右下隅にある「**リンクの追加**」エントリを選択し、ドロップダウン リストで 「**新規項目**」を選択します。
1.  「**リンクの追加**」パネルの 「**作業項目の種類**」ドロップダウン リストで、「**機能**」を選択し、「**タイトル**」テキスト ボックスに「**トレーニング ダッシュボード**」と入力して、「**OK**」をクリックします。

 
    ![タイトル「Training Dashboard」 を含めて、「OK」をクリックします](images/m1/child_feature_v1.png)
...
1.  **「最新のチュートリアルの追加ページ」** タスクを自分に割り当てます。 

    > **注**: これにより「**作業の詳細**」ペインの「**割り当て先**」セクションが自動的に更新されます。
...
1.  「**ダッシュボード**」ペインで、「**Azure Boards を使用したアジャイル プランニングとポートフォリオ管理 - 概要**」のタイトルの横のドロップダウン メニューを選択し、「**+ 新しいダッシュボード**」を選択します。
...
1.  「**新しいクエリ**」パネルの「**名前の入力**」テキストボックスに、「**Web タスク**」と入力して、「**フォルダ－**」ドロップダウン リストで、「**共有クエリ**」を選択し、「**OK**」をクリックします。
