...
1.  **[Pipelines]** ペインで **[Terraform-CI]** をクリックして選択します。**[Terraform-CI]** ペインで **[編集]** をクリックします。
...
1.  Azure DevOps ポータルで、Azure DevOps ポータルの左側にある縦型のメニューの **Pipelines** セクションで **[リリース]** をクリックします。**Terraform-CD** エントリが選択されていることを確認し、**[編集]** をクリックします。
...
1.  **Dev** ステージのタスク リストで **[Terraform ファイルでトークンを置き換える]** タスクを選択します。 タスクの **[トークン パターン]** プロパティを、**webapp.tf** ファイル内のトークンと一致するように `__...__` に更新します。
